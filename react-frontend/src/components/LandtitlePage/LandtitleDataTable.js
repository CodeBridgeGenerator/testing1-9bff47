...
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.landtitle}</p>
...
<Column field="landtitle" header="Landtitle" body={pTemplate1} filter={selectedFilterFields.includes("landtitle")} hidden={selectedHideFields?.includes("landtitle")}  sortable style={{ minWidth: "8rem" }} />
